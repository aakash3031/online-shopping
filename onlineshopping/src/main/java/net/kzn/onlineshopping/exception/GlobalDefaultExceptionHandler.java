...
public class GlobalDefaultExceptionHandler {
	...
	public ModelAndView noHandlerFoundException() {
		...
		mv.addObject("errorDescription", "The page that you are requested is not available now!");
	...
	public ModelAndView noProductFoundException() {
		...
		mv.addObject("errorDescription", "The product that you are requested is not available right now!");
		mv.addObject("title", "Product Unavailable");
		return mv;
	}
	
	@ExceptionHandler(Exception.class)
	public ModelAndView globleHandlerException(Exception ex) {
	ModelAndView mv = new ModelAndView("error");
